...
# Disponibilités enseignants
    path('disponibilites/enseignants/', views.liste_disponibilites_enseignants, name='liste_disponibilites_enseignants'),
    path('disponibilites/enseignants/ajouter/', views.ajouter_disponibilite_enseignant, name='ajouter_disponibilite_enseignant'),
    path('disponibilites/enseignants/modifier/<int:pk>/', views.modifier_disponibilite_enseignant, name='modifier_disponibilite_enseignant'),
    path('disponibilites/enseignants/supprimer/<int:pk>/', views.supprimer_disponibilite_enseignant, name='supprimer_disponibilite_enseignant'),

    # Disponibilités salles
    path('disponibilites/salles/', views.liste_disponibilites_salles, name='liste_disponibilites_salles'),
    path('disponibilites/salles/ajouter/', views.ajouter_disponibilite_salle, name='ajouter_disponibilite_salle'),
    path('disponibilites/salles/modifier/<int:pk>/', views.modifier_disponibilite_salle, name='modifier_disponibilite_salle'),
    path('disponibilites/salles/supprimer/<int:pk>/', views.supprimer_disponibilite_salle, name='supprimer_disponibilite_salle'),
